...
const uint PIN_SD_CS = 24;
const uint PIN_SD_TX = 23;
const uint PIN_SD_RX = 20;
const uint PIN_SD_SCK = 22;
...
static spi_t spis[] = {  // One for each SPI.
    {
        ...
        .miso_gpio = PIN_SD_RX, // GPIO number (not pin number)
        .mosi_gpio = PIN_SD_TX,
        .sck_gpio = PIN_SD_SCK,
...
static sd_card_t sd_cards[] = {  // One for each SD card
    {
        ...
        .ss_gpio = PIN_SD_CS,    // The SPI slave select GPIO for this SD card
        .use_card_detect = false,
        .card_detect_gpio = 77,   // Card detect
